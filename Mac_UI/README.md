...
| 06 | 章节生成管道 | `images/06-chapter-generation-pipeline.png` | `pseudocode/06-chapter-generation-pipeline.md` | M4.4 + M6.2/M6.3 |
| 07 | AI 对话面板 | `images/07-ai-conversation-panel.png` | `pseudocode/07-ai-conversation-panel.md` | M4.5 + M6.7 |
| 08 | 统一校验报告 | `images/08-unified-validation-report.png` | `pseudocode/08-unified-validation-report.md` | M6.4 |
